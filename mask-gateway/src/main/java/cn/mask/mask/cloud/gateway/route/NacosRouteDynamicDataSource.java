package cn.mask.mask.cloud.gateway.route;
        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    String configInfo = configService.getConfig("gateway-dynamic-route-rule.json", "dev"
                            , 4000);
                    log.info("获取网关当前配置:\r\n{}", configInfo);
                ...
                dynamicRouteByNacosListener("gateway-dynamic-route-rule.json", "dev");
            }
        }
    }
